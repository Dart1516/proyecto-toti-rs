...
import HeaderMinhaConta from "../Components/HeaderMinhaConta";
  ...
  return (
    <div className="App-Conta">
      ...
      <div className="section">
        ...
        <div className="inputs">
          ...
          <div className="input-field">
            ...
            <input type="text" id="endereco" placeholder="Endereço" className="input-text" />
          </div>
          <div className="input-field">
      ...
      <div className="section">
        ...
        <div className="input-field">
          <label htmlFor="enderecoOng">Endereço</label>
          <input type="text" id="enderecoOng" placeholder="Endereço" className="input-text" />
        </div>
