      ...
      <div className="container-body">
        <div className="aviso-legal">
          ...
          <div className="legal-content">
            <p>
              Ao marcar a caixa abaixo, eu, [Nome do Psicólogo], registro
              profissional [Número do Registro], concordo com os seguintes
              termos de responsabilidade como psicólogo voluntário da [Nome da
              Instituição]:
            </p>
            ...
            <p>Ao marcar a caixa, confirmo que li e aceito os termos acima:</p>
