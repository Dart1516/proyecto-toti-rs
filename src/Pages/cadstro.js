        ...
        <div className="cuadro-opciones">
          <div className="grupo-opciones">
            <div className="opcion">
              <Link to="./Home"> {/* Enlace a la página de voluntario */}
                <div className="icono">
                  <FaUser />
                </div>
            ...
            <div className="opcion">
              <Link to="./FormularioPsicologo"> {/* Enlace a la página de ONG */}
                <div className="icono">
                  <FaBuilding />
                </div>
                <div className="opciones-texto">
          ...
          <div className="grupo-opciones">
            <div className="opcion">
              <Link to="./FormularioEducadorSocial"> {/* Enlace a la página de educación */}
                <div className="icono">
                  <FaBook />
                </div>
                <div className="opciones-texto">
            ...
            <div className="opcion">
              <Link to="./FormularioLiderImigrante"> {/* Enlace a la página de otros */}
                <div className="icono">
                  <FaEllipsisH />
                </div>
                <div className="opciones-texto">
