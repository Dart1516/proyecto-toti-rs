          ...
          <div className="main">
            <div className="text-home">
              ...
              <div className="areabuttom">
                <a className="sub-text-home buttom0 buttom1" href="./JoinUs">
                  Quero ser voluntário
                </a>
                <a className="sub-text-home buttom0 buttom2" href="./JoinUs">
                  Quero ser atendido
                </a>
              </div>
            </div>
          ...
          <div className="card-container">
            <div className="card-item">
              ...
              <div className="card-text">
                ...
                <p>
                  O especialista capaz de oferecer ajuda psicologica, dando as
        ...
        <div id="registro-processo">
          <div className="proceso-voluntariado">
            ...
            <div className="proceso-texto">
              <h2>registro</h2>
              <p>
                complete o <a href="./JoinUs">formulário</a> de inscrição com
            ...
            <div className="proceso-texto">
              ...
              <p>
                {" "}
                iram ao banco de dados que estará disponivel para os lideres dos
            ...
            <div className="proceso-texto contato">
              ...
              <p>
                Começe a oferecer seu apoio às comunidades afetadas. O líder
          ...
          <div className="proceso-voluntariado lideranca">
            ...
            <div className="proceso-texto-lideranca">
              ...
              <p>
                ...
                dos voluntarios disponiveis para atentimento dos seus refugiados
              </p>
            </div>
            <div className="proceso-texto-lideranca">
              <h2>contato</h2>
              <p>
                Será disponivilizado telefone e email do voluntario para você
